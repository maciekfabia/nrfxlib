...
#ifdef CONFIG_ZBOSS_TRACE_LOG_LEVEL
#define ZB_TRACE_LEVEL CONFIG_ZBOSS_TRACE_LOG_LEVEL
#endif

#ifdef CONFIG_ZBOSS_TRACE_MASK
#define ZB_TRACE_MASK CONFIG_ZBOSS_TRACE_MASK
#endif
